...
class LLMError(CloudError):
    """LLM API error (OpenAI, Anthropic, etc.)."""
...
class LLMAuthError(AuthenticationError):
...
class LLMContextLengthError(LLMError):
    ...
    def __init__(
        ...
        if max_tokens and requested_tokens:
            message = f"Context length exceeded: {requested_tokens} > {max_tokens}"
