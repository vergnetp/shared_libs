...
class QueueLoggingConfig:
    ...
    def _create_default_logger(self):
        ...
        return type('SimpleLogger', (), {
            'error': lambda self, msg, **kwargs: print(f"ERROR: {msg}"),
            'warning': lambda self, msg, **kwargs: print(f"WARNING: {msg}"),
            'info': lambda self, msg, **kwargs: print(f"INFO: {msg}"),
            'debug': lambda self, msg, **kwargs: print(f"DEBUG: {msg}"),
            'critical': lambda self, msg, **kwargs: print(f"CRITICAL: {msg}")
        })()
