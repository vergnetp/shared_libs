...
|Decorators| Method |Args|Returns| Category| Description |
| ------------------------------ |---| --|---| --| -------------------------------- |
|<code style="background-color:lightgreen">@property</code>| `parameter_converter` ||<a href="#class-sqlgenerator">`SqlGenerator`</a>|Configuration| Returns the parameter converter for this connection. |
