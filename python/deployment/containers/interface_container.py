...
class ContainerImage:
    ...
    def __init__(
        ...
        build_context: str = ".",
        container_file: str = "Containerfile"  # Generic name, not "Dockerfile"
    ):
        self.name = name
        self.tag = tag
        self.registry = registry
        self.build_context = build_context
        self.container_file = container_file  # Could be Dockerfile, Containerfile, etc.
...
# ============================================================================
# 2. Abstract Interfaces for Container Operations
# ============================================================================
